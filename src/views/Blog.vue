            ...
            <v-card-text>
                <v-simple-table dense>
                    <tbody>
                        ...
                        <tr>
                            <td><v-icon>mdi-text</v-icon> Deskripsi</td>
                            <td>
                                {{ blog.description }}    
                            </td>    
                        </tr>
                        <tr>
                            <td>
                                <v-btn color="success" class="mt-1 mr-1">EDIT</v-btn>
                                <v-btn color="primary" class="mt-1 mr-1">UPLOAD PHOTO</v-btn>
                                <v-btn color="error" class="mt-1">DELETE</v-btn>    
                            </td>    
                        </tr>    
                    </tbody>    
                </v-simple-table>    
